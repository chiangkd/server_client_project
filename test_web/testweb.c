/* This project is modified from tiny-web-server */
...
/* written return type is ssize_t (signed long) because if occurs error, it should return -1, which is signed number */
...
/* typedef for socket programming */
...
void serve_static(int out_fd, int in_fd, http_request *req,
	...
	/* if file is too big, use while to load it */
